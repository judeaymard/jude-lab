        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="sticky top-40 space-y-12">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl font-bold tracking-tighter uppercase">{product.name}</h1>
            ...
            <div className="space-y-10">
                ...
                <div className="flex space-x-4">
                  {product.colors.map(color => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full border-2 transition-all ${selectedColor === color ? 'border-secondary-container scale-110 shadow-lg' : 'border-outline-variant hover:border-primary'}`}
                ...
                <div className="flex flex-wrap gap-3">
                  {product.sizes.map(size => (
                    <button
                      ...
                      className={`px-6 py-3 border text-xs font-bold uppercase tracking-widest transition-all ${selectedSize === size ? 'bg-primary text-white border-primary' : 'bg-transparent border-outline-variant hover:border-primary'}`}
                    >
                      {size}
                    </button>
                  ))}
              ...
              <div className="flex space-x-6">
                <div className="flex items-center border border-outline-variant px-6 py-4">
                ...
                <button
                  ...
                  className="flex-grow bg-secondary-container text-white font-bold uppercase tracking-widest py-4 px-8 text-sm hover:bg-opacity-90 transition-all shadow-xl"
                >
                  Ajouter au Panier
                </button>
              </div>
            ...
            <div className="border-t border-outline-variant pt-10">
              ...
              <ul className="space-y-3 list-disc pl-4 text-sm text-on-surface-variant">
